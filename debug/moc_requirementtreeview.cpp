...
struct qt_meta_stringdata_CscrToolDialog_t {
    QByteArrayData data[7];
    char stringdata0[82];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_CscrToolDialog_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CscrToolDialog_t qt_meta_stringdata_CscrToolDialog = {
    {
QT_MOC_LITERAL(0, 0, 14), // "CscrToolDialog"
QT_MOC_LITERAL(1, 15, 17), // "loadBugReportFile"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 12), // "reviewMethod"
QT_MOC_LITERAL(4, 47, 19), // "handleOptionChanged"
QT_MOC_LITERAL(5, 67, 2), // "id"
QT_MOC_LITERAL(6, 70, 11) // "onOkClicked"

    },
    "CscrToolDialog\0loadBugReportFile\0\0"
    "reviewMethod\0handleOptionChanged\0id\0"
    "onOkClicked"
};
#undef QT_MOC_LITERAL

static const uint qt_meta_data_CscrToolDialog[] = {
...
void CscrToolDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        CscrToolDialog *_t = static_cast<CscrToolDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->loadBugReportFile((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 1: _t->reviewMethod((*reinterpret_cast< QString(*)>(_a[1]))); break;
        case 2: _t->handleOptionChanged((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            typedef void (CscrToolDialog::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CscrToolDialog::loadBugReportFile)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (CscrToolDialog::*_t)(QString );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&CscrToolDialog::reviewMethod)) {
                *result = 1;
                return;
            }
        }
...
const QMetaObject CscrToolDialog::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_CscrToolDialog.data,
      qt_meta_data_CscrToolDialog,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};


const QMetaObject *CscrToolDialog::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->dynamicMetaObject() : &staticMetaObject;
}

void *CscrToolDialog::qt_metacast(const char *_clname)
{
    if (!_clname) return Q_NULLPTR;
    if (!strcmp(_clname, qt_meta_stringdata_CscrToolDialog.stringdata0))
        return static_cast<void*>(const_cast< CscrToolDialog*>(this));
    return QDialog::qt_metacast(_clname);
}

int CscrToolDialog::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = QDialog::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
...
// SIGNAL 0
void CscrToolDialog::loadBugReportFile(QString _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
    QMetaObject::activate(this, &staticMetaObject, 0, _a);
}
...
// SIGNAL 1
void CscrToolDialog::reviewMethod(QString _t1)
{
    void *_a[] = { Q_NULLPTR, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
