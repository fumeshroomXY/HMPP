...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_IssueManager_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_IssueManager_t qt_meta_stringdata_IssueManager = {
    {
QT_MOC_LITERAL(0, 0, 12) // "IssueManager"
...
static const uint qt_meta_data_IssueManager[] = {
...
const QMetaObject IssueManager::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_IssueManager.data,
      qt_meta_data_IssueManager,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *IssueManager::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_IssueManager.stringdata0))
        return static_cast<void*>(const_cast< IssueManager*>(this));
